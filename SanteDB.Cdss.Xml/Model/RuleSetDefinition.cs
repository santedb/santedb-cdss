...
namespace SanteDB.Protocol.Xml.Model
{
    ...
    /// </summary>
    [XmlType(nameof(RuleSetTriggerEvent), Namespace = "http://santedb.org/cdss")]
    ...
    /// </summary>
    [XmlType(nameof(RuleSetDefinition), Namespace = "http://santedb.org/cdss")]
    [XmlRoot(nameof(RuleSetDefinition), Namespace = "http://santedb.org/cdss")]
    public class RuleSetDefinition : DecisionSupportBaseElement
    {
        ...
        /// </summary>
        [XmlElement("initialize", Namespace = "http://santedb.org/model/view")]
    ...
    /// </summary>
    [XmlType(nameof(RuleSetTrigger), Namespace = "http://santedb.org/cdss")]
